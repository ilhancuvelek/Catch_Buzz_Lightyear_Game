...
class MediumModeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let highScoreString = UserDefaults.standard.string(forKey: "high_score_medium") {
        ...
        buzzTimer=Timer.scheduledTimer(timeInterval: 0.7, target: self, selector: #selector(buzzTimerFunction), userInfo: nil, repeats: true)
    }
    ...
    @objc func timerFunction(){
        ...
        if counter==0{
            ...
            if highScore<score{
                UserDefaults.standard.setValue(score, forKey: "high_score_medium")
                highScoreLabel.text="High Score : \(score)"
            }else{
                UserDefaults.standard.setValue(highScore, forKey: "high_score_medium")
